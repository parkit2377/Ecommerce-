...
export default function AdminLayout() {
  ...
  const isSidenavOpen = useSelector((state) => state.adminToggleSidenav.showAdminSidenav);
...
return (
    ...
    <div className="flex h-screen bg-[#F7F7F7]">
      <div className={`sidenav  h-full ${isSidenavOpen ? 'w-64' : 'w-0'} transition-all duration-300 ease-in-out`}>
        <AdminSideBar />
      </div>
